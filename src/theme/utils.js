...
export const setShadow = (
  ...
  if (style === "light") {
    return `${inset} 0 2px 8px ${setColor.black}, 30};`
  }
  if (style === "medium") {
    return `${inset} 0 3px 12px ${setColor.black}, 50;`
  }
  if (style === "dark") {
    return `${inset} 0 5px 15px ${setColor.black}, 80;`
  }
  if (style === "none") {
    return `none;`
  } else {
    return `${y}px ${x}px ${blur}px ${color}, ${opacity};`
  }
}
